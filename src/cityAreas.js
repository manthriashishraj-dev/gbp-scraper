...
export const CITY_AREAS = {
  ...
  hyderabad: [
    ...
    'Ameerpet Hyderabad', 'Begumpet Hyderabad', 'Secunderabad',
    'Miyapur Hyderabad', 'Kompally Hyderabad',
    'LB Nagar Hyderabad', 'Dilsukhnagar Hyderabad',
    'Kothapet Hyderabad', 'Uppal Hyderabad', 'Nacharam Hyderabad',
    'Malkajgiri Hyderabad', 'ECIL Hyderabad', 'AS Rao Nagar Hyderabad',
    'Sainikpuri Hyderabad', 'Alwal Hyderabad',
    'Mehdipatnam Hyderabad', 'Tolichowki Hyderabad',
    'Attapur Hyderabad', 'Himayatnagar Hyderabad',
    'Nampally Hyderabad', 'Abids Hyderabad',
    'Musheerabad Hyderabad', 'Amberpet Hyderabad',
    'Malakpet Hyderabad', 'Charminar Hyderabad',
    'Saidabad Hyderabad', 'Vanasthalipuram Hyderabad',
    'Boduppal Hyderabad', 'Nagole Hyderabad',
    'Hayathnagar Hyderabad', 'Rajendranagar Hyderabad',
    'Shamshabad Hyderabad', 'Narsingi Hyderabad',
    'Kokapet Hyderabad', 'Nanakramguda Hyderabad',
    'Manikonda Hyderabad', 'Serlingampally Hyderabad',
    'Patancheru Hyderabad', 'Bahadurpally Hyderabad',
    'Quthbullapur Hyderabad', 'Moosapet Hyderabad',
    'Sanathnagar Hyderabad', 'SR Nagar Hyderabad',
    'Bowenpally Hyderabad', 'Trimulgherry Hyderabad',
  ],
